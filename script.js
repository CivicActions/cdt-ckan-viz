var config = {
  widgets: [
    ...
    {
      "elementId": "unemployment_alameda_average",
      "view": {
        "metadata": {},
        "resources": [
          {
            ...
            "transform": [
              {
                "type": "filter",
                "expression": "(data['Area Type'] == 'County') && (data['Area Name'] == 'Alameda County')"
              }
            ]
          }
        ],
    ...
    {
      "elementId": "unemployment_santa_cruz_average",
      "view": {
        "metadata": {},
        "resources": [
          {
            ...
            "transform": [
              {
                "type": "filter",
                "expression": "(data['Area Type'] == 'County') && (data['Area Name'] == 'Santa Cruz County')"
              }
            ]
          }
        ],
